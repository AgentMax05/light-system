...
#DEVICE = 'pi'
DEVICE = 'pi-sk9822'
"""Device used to control LED strip. Must be 'pi', 'pi-sk9822', 'esp8266' or 'blinkstick'
...
audio input and control the LED strip directly (WS2812B/NeoPixel).

'pi-sk9822' means that you are using a Raspberry Pi with SK9822/APA102 LED strips
via SPI interface.
